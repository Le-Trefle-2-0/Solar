        ...
        <section
            ...
            <div
                ...
                <div className="flex-1 flex items-center">
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center w-full">
                        <div
                            ...
                            <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl italic leading-tight">
                ...
                <div
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-end w-full sm:w-auto">
