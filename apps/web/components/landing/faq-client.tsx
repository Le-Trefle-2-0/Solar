...
const faqData = [
    {
        ...
        questions: [
            ...
            },
            {
                ...
                answer: "Bien que le serveur ne soit pas un serveur communautaire, il reste tout de même un hybride entre un serveur communautaire et un serveur d’écoute. Il est donc important pour nous de disposer d’équipes dédiées à la communauté. Notre prochaine assemblée générale doit voter la mise en place d’équipes dédiées respectivement à, la modération, l’animation, la gestion de la communauté, ainsi qu’une équipe de helpers. Dans l’immédiat, les modérateurs disposent d’un rôle polyvalent a l’intermédiaire de ce que seront à l’avenir les équipes de modération, d’animation, ainsi que les helpers. Les techniciens sont quant à eux actuellement assez polyvalent dans leur rôle concernant à la fois la technique Discord, mais aussi le développement du bot d’écoute et de notre future plateforme Solar. Cette équipe sera également séparée en deux, avec une équipe technique dédiée à Discord ainsi qu’une équipe infrastructure dédiée au site internet, au bot ainsi qu’à l’application Solar."
            },
            {
                id: "v2023-13",
                question: "Qu’est-ce que la future application Solar ?",
                answer: "Solar est une application en cours de développement depuis un an et demi qui sera à l’avenir utilisé par tous nos bénévoles écoutants. Cette plateforme a pour objectif de faciliter l’organisation du planning ainsi que la prise en charge des écoutes. Pour les utilisateurs, cette plateforme ne changera pas le fonctionnement des écoutes car notre bot d’écoutes restera le même sur Discord, et sera lui lié aux bénévoles écoutants sur Solar. Cette plateforme nous permettra également d’imposer des standards de sécurité et de chiffrement de données plus importants que ceux mis en place par Discord, car la confidentialité et la sécurité restent parmi nos objectifs majeurs."
            },
            {
                id: "v2023-14",
